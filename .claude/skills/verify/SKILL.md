...
- `PORT=.. node .claude/skills/verify/verify-hebrew.mjs` self-asserts the Hebrew i18n feature end-to-end: locale-based default language, the En/ע toggle (sidebar, warnings, map controls, RTL dir), localStorage persistence across reloads, and the printable report's language.
